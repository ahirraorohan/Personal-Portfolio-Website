          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  // href="https://github.com/CodeVinayak/MultilingualVQA"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>Crypto Currencies Tracker</h3>
              <p>
                The Crypto Currencies Tracker is a secure web app built with
                React.js, Bootstrap, and Node.js that provides real-time
                cryptocurrency data, including prices, market capitalization,
                and trading volumes. It helps investors make informed decisions
                by offering accurate and up-to-date insights into market trends.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/ahirraorohan/Movies-Website-Project"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              ...
              <p>
                {" "}
                The Movies Website Project is a responsive web app built with
                HTML, CSS, and JavaScript that fetches movie data such as
                titles, posters, and descriptions from the TMDB API. It includes
                features like search, filtering, and dynamic movie rendering,
                showcasing skills in frontend development and API integration.{" "}
              </p>
            </div>
            <footer>
              {" "}
              <ul className="tech-list">
                {" "}
                <li>API</li> <li>MySQL</li> <li>Bootstrap</li>{" "}
              </ul>{" "}
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/ahirraorohan/Airline-Reservation-System-"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />{" "}
            ...
            <div className="body">
              ...
              <p>
                The Airline Reservation System is a web-based application
                developed using HTML, CSS, Java, JSP Servlet, JDBC, and MySQL.
                It streamlines the process of booking and managing airline
                tickets, allowing travelers to browse flight options, select
                seats, make reservations, and pay securely through a
